...
const About = () => {
	return (
		<section data-scroll-section className={'relative bg-cream my-24'}>
			{/* Triangles */}
			...
			<div className={'container h-full flex flex-col-reverse lg:flex-row justify-between gap-16 overflow-hidden py-10'}>
				<div className={'relative bg-white w-full pl-10 lg:pl-28 pr-8 lg:pr-12 py-24 basis-2/3 flex flex-col justify-center'}>
					...
					{/* About us text */}
					<h1 data-scroll data-scroll-speed={0.05} className={'z-10'}>About Us</h1>
					<p data-scroll data-scroll-speed={0.05} className={'mt-6 lg:mt-10 lg:w-2/3 w-full lg:max-w-[550px] z-20'}>
				...
				<div data-scroll data-scroll-speed={0.1} className={'absolute lg:relative max-w-[30%] lg:w-full h-min top-0 right-[4%] lg:right-0 -translate-y-[35%] lg:translate-y-0 basis-1/3'}>
